/*
        ...
        Notice: Copy from https://github.com/983/ChaCha20
...
struct Chacha20Codec {
    ...
    Chacha20Codec(const uint8_t key[32], const uint8_t nonce[8], uint64_t counter = 0): block(key, nonce), position(64)
    {
